  ...
  const handleSubmit = async () => {
    ...
    if (isValidated) {
      ...
      toast({
        ...
        description:
          "Please make sure to select both a start and end time and make sure the end time is at least 15 minutes after the start time.",
      });
    }
    setLoading(false);
  };
              ...
              <div className="grid w-full items-center gap-4">
                ...
                <div className="flex flex-col space-y-1.5">
                  ...
                  <Input
                    ...
                    value={startTime}
                    className="w-full"
                    placeholder="Start time for your slot"
                    onInput={(i) => setStartTime(i.target.value)}
                  />
                </div>
                <div className="flex flex-col space-y-1.5">
                  ...
                  <Input
                    ...
                    disabled={loading}
                    value={endTime}
                    placeholder="End time for your slot"
                    onInput={(i) => setEndTime(i.target.value)}
                  />
                </div>
              </div>
            </form>
